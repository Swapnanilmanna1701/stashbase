...
- **Journey E2E:** [document editing smoke](../e2e/smoke/document-editing.spec.ts),
  ...
  format classes and document work, including XLSX worksheet navigation,
  selection/copy, merged and frozen cells, images and charts, inert formulas
  and external links, preview independence, and other preview-only affordances,
...
- **Release Check:** operating-system screenshot capture and representative
  PDF/OCR/DOCX/XLSX/media preparation with packaged native helpers remain release
  evidence.
