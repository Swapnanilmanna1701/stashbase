...
export function FileTypeIcon({ format }: { format: FileGlyphFormat }) {
  ...
  if (format === 'xlsx') {
    return (
      <svg viewBox="0 0 256 256" fill="currentColor" aria-hidden="true"><path d="M216,88V216a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V40A16,16,0,0,1,56,24h96a8,8,0,0,1,5.66,2.34l56,56A8,8,0,0,1,216,88ZM152,44V88h44ZM161.47,144.48a8,8,0,0,0-11,2.05L128,178.43l-22.45-31.9a8,8,0,1,0-13.08,9.2L118.22,192,92.47,228.27a8,8,0,0,0,13.06,9.26L128,205.57l22.47,32a8,8,0,0,0,13.06-9.2L137.78,192l25.75-36.47A8,8,0,0,0,161.47,144.48Z"/></svg>
    );
  }
  if (format === 'audio') {
    return (
