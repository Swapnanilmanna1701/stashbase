...
export const SPREADSHEET_EXTENSIONS = ['xlsx'] as const;
...
export const SPREADSHEET_EXTENSION_ALTERNATION = extensionAlternation(SPREADSHEET_EXTENSIONS);
 ...
 */
export type ViewerFormat = DirectTextFormat | 'pdf' | 'image' | 'docx' | 'xlsx' | 'audio';
